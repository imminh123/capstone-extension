...
$(document).ready(function () {
       ...
       <div class="folderOption" id="folderOption">
           ...
           <ul class="searchInputList">
            ...
            <div id="createFolderBtn">
                    ...
                    <span class="createBtnTitle">Create folder ""</span>
                </div>
        </div>
    </div>
    ...
    <div class="noteDetail" id="noteDetail">
            ...
            <div class="dropdown">
                ...
                <div id="createFolderBtnInNote">
                    ...
                    <span class="createBtnTitleInNote">Create folder ""</span>
                </div>
            </div>
    ...
    $(document.body).on("click", "#addBtn", function () {
        ...
        var description = "<p>" + $('#descNotes').val() + "</p>";
        var insertNotes = {
            "studentID": getStudentId,
            "folderID": folderId,
            "scannedContent": string,
    ...
    //Initiate dropdown
function initiateDropdown(mode) {
    ...
    inputField.addEventListener('input', () => {
        ...
        if(matchItem.length == 0 && mode != 'teacher') {
