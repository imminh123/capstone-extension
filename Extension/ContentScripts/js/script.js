...
';
    ...
    <input type="text" id ="getStudentName" class="getStudentName" />\
...
';
    ...
    // $.ajax({
    //     type: "GET",
    //     url: "https://capstonebackendapi.herokuapp.com/getHighlightByUrl/"+ getStudentId + "/" + encodeURIComponent(window.location.href),
    //     success: function (data) {
